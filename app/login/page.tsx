...
import { MapPin, Eye, EyeOff, Mail, Lock, ArrowRight, Loader2 } from "lucide-react"
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-2xl font-bold">Problem Map</span>
            </div>
            ...
            <div className="mt-12 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/80">Problems reported</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                  <span className="text-sm font-semibold">8K+</span>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/80">Cities connected</span>
              </div>
            </div>
          </motion.div>
        </div>
